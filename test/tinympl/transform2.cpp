...
#if TINYMPL_TRANSFORM2_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/transform2.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/transform2.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(transform2)
...
#endif // TINYMPL_TRANSFORM2_TEST_ENABLED
