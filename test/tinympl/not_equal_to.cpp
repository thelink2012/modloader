...
#if TINYMPL_NOT_EQUAL_TO_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/not_equal_to.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/not_equal_to.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(not_equal_to)
...
#endif // TINYMPL_NOT_EQUAL_TO_TEST_ENABLED
