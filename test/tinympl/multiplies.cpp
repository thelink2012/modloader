...
#if TINYMPL_MULTIPLIES_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/multiplies.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/multiplies.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(multiplies)
...
#endif // TINYMPL_MULTIPLIES_TEST_ENABLED
