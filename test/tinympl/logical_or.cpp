...
#if TINYMPL_LOGICAL_OR_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/logical_or.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/logical_or.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(logical_or)
...
#endif // TINYMPL_LOGICAL_OR_TEST_ENABLED
