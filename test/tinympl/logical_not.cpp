...
#if TINYMPL_LOGICAL_NOT_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/logical_not.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/logical_not.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(logical_not)
...
#endif // TINYMPL_LOGICAL_NOT_TEST_ENABLED
