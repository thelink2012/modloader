...
#if TINYMPL_LEXICOGRAPHICAL_COMPARE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/lexicographical_compare.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/lexicographical_compare.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(lexicographical_compare)
...
#endif // TINYMPL_LEXICOGRAPHICAL_COMPARE_TEST_ENABLED
