...
#if TINYMPL_VARIADIC_REMOVE_IF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/remove_if.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_REMOVE_IF_TEST_ENABLED
