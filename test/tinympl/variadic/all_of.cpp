...
#if TINYMPL_VARIADIC_ALL_OF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/all_of.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_ALL_OF_TEST_ENABLED
