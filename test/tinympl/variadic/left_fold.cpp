...
#if TINYMPL_VARIADIC_LEFT_FOLD_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/left_fold.hpp, then <tinympl/unit_test.hpp>
...
BOOST_AUTO_TEST_SUITE(left_fold)
...
#endif // TINYMPL_VARIADIC_LEFT_FOLD_TEST_ENABLED
