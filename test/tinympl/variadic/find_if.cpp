...
#if TINYMPL_VARIADIC_FIND_IF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/find_if.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_FIND_IF_TEST_ENABLED
