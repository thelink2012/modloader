...
#if TINYMPL_VARIADIC_FILL_N_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/fill_n.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_FILL_N_TEST_ENABLED
