...
#if TINYMPL_SET_DIFFERENCE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/set_difference.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/set_difference.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(set_difference)
...
#endif // TINYMPL_SET_DIFFERENCE_TEST_ENABLED
