...
#if TINYMPL_SET_INTERSECTION_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/set_intersection.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/set_intersection.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(set_intersection)
...
#endif // TINYMPL_SET_INTERSECTION_TEST_ENABLED
