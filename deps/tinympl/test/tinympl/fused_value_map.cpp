...
#if TINYMPL_FUSED_VALUE_MAP_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/fused_value_map.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/fused_value_map.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(fused_value_map)
...
#endif // TINYMPL_FUSED_VALUE_MAP_TEST_ENABLED
