...
#if TINYMPL_UNORDERED_EQUAL_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/unordered_equal.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/unordered_equal.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(unordered_equal)
...
#endif // TINYMPL_UNORDERED_EQUAL_TEST_ENABLED
