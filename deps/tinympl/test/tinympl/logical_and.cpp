...
#if TINYMPL_LOGICAL_AND_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/logical_and.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/logical_and.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(logical_and)
...
#endif // TINYMPL_LOGICAL_AND_TEST_ENABLED
