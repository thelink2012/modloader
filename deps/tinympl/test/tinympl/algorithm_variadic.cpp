...
#if TINYMPL_ALGORITHM_VARIADIC_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/algorithm_variadic.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/algorithm_variadic.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(algorithm_variadic)
...
#endif // TINYMPL_ALGORITHM_VARIADIC_TEST_ENABLED
