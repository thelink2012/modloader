...
#if TINYMPL_SIZEOF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/sizeof.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/sizeof.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(sizeof_)
...
#endif // TINYMPL_SIZEOF_TEST_ENABLED
