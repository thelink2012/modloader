...
#if TINYMPL_STRING_MACRO_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/string_macro.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/string_macro.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(string_macro)
...
#endif // TINYMPL_STRING_MACRO_TEST_ENABLED
