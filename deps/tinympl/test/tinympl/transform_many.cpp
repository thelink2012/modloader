...
#if TINYMPL_TRANSFORM_MANY_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/transform_many.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/transform_many.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(transform_many)
...
#endif // TINYMPL_TRANSFORM_MANY_TEST_ENABLED
