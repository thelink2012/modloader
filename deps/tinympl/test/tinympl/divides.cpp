...
#if TINYMPL_DIVIDES_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/divides.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/divides.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(divides)
...
#endif // TINYMPL_DIVIDES_TEST_ENABLED
