...
#if TINYMPL_SET_UNION_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/set_union.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/set_union.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(set_union)
...
#endif // TINYMPL_SET_UNION_TEST_ENABLED
