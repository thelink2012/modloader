...
#if TINYMPL_IS_SEQUENCE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/is_sequence.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/is_sequence.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(is_sequence)
...
#endif // TINYMPL_IS_SEQUENCE_TEST_ENABLED
