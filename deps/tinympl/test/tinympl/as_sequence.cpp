...
#if TINYMPL_AS_SEQUENCE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/as_sequence.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/as_sequence.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(as_sequence)
...
#endif // TINYMPL_AS_SEQUENCE_TEST_ENABLED
