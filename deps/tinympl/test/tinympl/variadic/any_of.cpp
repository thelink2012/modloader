...
#if TINYMPL_VARIADIC_ANY_OF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/any_of.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_ANY_OF_TEST_ENABLED
