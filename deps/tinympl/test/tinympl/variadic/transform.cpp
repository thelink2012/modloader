...
#if TINYMPL_VARIADIC_TRANSFORM_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/transform.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_TRANSFORM_TEST_ENABLED
