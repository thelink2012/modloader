...
#if TINYMPL_VARIADIC_REVERSE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/reverse.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_REVERSE_TEST_ENABLED
