...
#if TINYMPL_VARIADIC_COUNT_IF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/count_if.hpp, then <tinympl/unit_test.hpp>
...
BOOST_AUTO_TEST_SUITE(count_if)
...
#endif // TINYMPL_VARIADIC_COUNT_IF_TEST_ENABLED
