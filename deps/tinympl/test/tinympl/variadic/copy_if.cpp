...
#if TINYMPL_VARIADIC_COPY_IF_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/copy_if.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_COPY_IF_TEST_ENABLED
