...
#if TINYMPL_VARIADIC_REPLACE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/replace.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_REPLACE_TEST_ENABLED
