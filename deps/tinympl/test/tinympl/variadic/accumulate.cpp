...
#if TINYMPL_VARIADIC_ACCUMULATE_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/variadic/accumulate.hpp, then <tinympl/unit_test.hpp>
...
#endif // TINYMPL_VARIADIC_ACCUMULATE_TEST_ENABLED
