...
#if TINYMPL_VALUE_MAP_TEST_ENABLE

// Order of includes is important!
// First, include tinympl/value_map.hpp, then <tinympl/unit_test.hpp>
#include <tinympl/value_map.hpp>
#include <tinympl/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(test_tinympl)
BOOST_AUTO_TEST_SUITE(value_map)
...
#endif // TINYMPL_VALUE_MAP_TEST_ENABLED
